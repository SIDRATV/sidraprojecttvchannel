      ...
      >
        {shortcuts.map((shortcut) => (
          ...
          >
            {/* Icon circle */}
            <div
              className={`relative w-12 h-12 rounded-xl bg-gradient-to-br ${shortcut.bgFrom} ${shortcut.bgTo} flex items-center justify-center shadow-md group-hover:scale-105 group-hover:shadow-lg transition-all duration-200`}
            >
              {shortcut.pulse && (
