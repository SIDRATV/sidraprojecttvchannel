    ...
    <div className="flex items-center justify-between py-2">
      ...
      <motion.button
        ...
        className={`relative w-12 h-6 rounded-full transition-colors ${
          enabled ? 'bg-purple-500' : 'bg-gray-400 dark:bg-gray-700'
        }`}
      >
        <motion.div
    ...
    <div className="space-y-8 p-4 md:p-8 max-w-4xl bg-white dark:bg-gray-950 min-h-screen transition-colors">
      ...
      >
        ...
        <div className="pt-2 border-t border-gray-700">
          ...
          <select className="w-full md:w-48 px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-sm focus:border-purple-500 outline-none transition-colors">
      ...
      <motion.button
        ...
        className="w-full md:w-48 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-semibold transition-colors"
      >
        Save Changes
      </motion.button>
    </div>
