...
export function AppHeader({ onSearch, showSearch = false }: AppHeaderProps) {
  ...
  return (
    ...
    <motion.header
      ...
      className="sticky top-0 z-[99999] bg-white/80 dark:bg-gray-900/90 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-800/50 transition-colors"
    >
            ...
            <AnimatePresence>
              {notificationsOpen && (
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl overflow-hidden z-[50000]"
                >
            ...
            <AnimatePresence>
              {profileOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  transition={{ duration: 0.2 }}
                  className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl overflow-hidden z-[50000]"
                >
                  {/* User Info */}
