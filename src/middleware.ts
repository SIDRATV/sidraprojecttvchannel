 ...
 *    - sidratvstoragevideopremium (videos): connect-src for uploads, media-src for playback
 *    - avatar-user-url (avatars): connect-src for uploads, img-src for avatar display
