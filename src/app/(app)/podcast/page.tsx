  ...
  useEffect(() => {
    const fetchPodcasts = async () => {
      ...
      try {
        ...
        setPodcasts([
          { id: 'p1', title: 'Tech Innovation Daily', description: 'Daily insights on the latest technology trends', image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&h=450&fit=crop', duration: '45 min', category: 'Technology', creator: 'Tech Leaders', views: 12500, likes: 890, created_at: new Date().toISOString() },
          { id: 'p2', title: 'Startup Stories', description: 'inspiring stories from successful startups', image: 'https://images.unsplash.com/photo-1516321318423-f06f70991a20?w=800&h=450&fit=crop', duration: '32 min', category: 'Business', creator: 'Startup Hub', views: 8900, likes: 650, created_at: new Date().toISOString() },
          { id: 'p3', title: 'Future of AI', description: 'Exploring artificial intelligence and machine learning', image: 'https://images.unsplash.com/photo-1618761490192-04901461159e?w=800&h=450&fit=crop', duration: '58 min', category: 'AI & ML', creator: 'AI Masters', views: 15200, likes: 1205, created_at: new Date().toISOString() },
          { id: 'p4', title: 'Live Podcast: Innovation', description: 'Live discussions about innovation in tech', image: 'https://images.unsplash.com/photo-1577720643272-265e434ff3a4?w=800&h=450&fit=crop', duration: 'LIVE', category: 'Podcast', creator: 'Live Team', views: 3200, likes: 420, created_at: new Date().toISOString() },
          { id: 'p5', title: 'Web Development Mastery', description: 'Master web development with modern frameworks', image: 'https://images.unsplash.com/photo-1633356122544-f134324ef6db?w=800&h=450&fit=crop', duration: '41 min', category: 'Development', creator: 'Dev Academy', views: 11000, likes: 780, created_at: new Date().toISOString() },
          { id: 'p6', title: 'Digital Marketing Trends', description: 'latest trends and strategies in digital marketing', image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=450&fit=crop', duration: '36 min', category: 'Marketing', creator: 'Marketing Pros', views: 9500, likes: 680, created_at: new Date().toISOString() },
        ]);
      } finally {
        setIsLoading(false);
      }
