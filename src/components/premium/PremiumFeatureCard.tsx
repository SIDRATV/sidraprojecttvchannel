  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-12 h-12 bg-gradient-to-br from-brand-500 to-brand-500 rounded-lg flex items-center justify-center mb-4 group-hover:shadow-lg group-hover:shadow-brand-500/50 transition-all"
      >
