    ...
    const fetchStreams = async () => {
      ...
      try {
        ...
        setStreams([
          ...
          { id: 'l3', title: 'AI Masterclass', description: 'Live AI class', image: 'https://images.unsplash.com/photo-1620712014215-c8ee9ae4aaae?w=800&h=450&fit=crop', viewers: 8300, category: 'Education', streamer: 'AI Masters', is_live: true, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
