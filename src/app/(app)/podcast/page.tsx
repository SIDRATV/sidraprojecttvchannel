  ...
  useEffect(() => {
    const fetchPodcasts = async () => {
      ...
      try {
        ...
        setPodcasts([
          { id: 'p1', title: 'Tech Innovation Daily', description: 'Daily insights on the latest technology trends', image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&h=450&fit=crop', duration: '45 min', category: 'Technology', creator: 'Tech Leaders', views: 12500, likes: 890, created_at: new Date().toISOString() },
          ...
          { id: 'p3', title: 'Future of AI', description: 'Exploring artificial intelligence and machine learning', image: 'https://images.unsplash.com/photo-1620712014215-c8ee9ae4aaae?w=800&h=450&fit=crop', duration: '58 min', category: 'AI & ML', creator: 'AI Masters', views: 15200, likes: 1205, created_at: new Date().toISOString() },
